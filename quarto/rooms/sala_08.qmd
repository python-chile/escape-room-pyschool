...
Las sentencias `if, elif, else` sirven para ejecutar cierto código si las condiciones de dichas sentencias se cumplen. No siempre
...
En este caso las sentencias ya están aplicadas, pero están igualadas (`==`) a valores erróneos. Basta con
reemplazar los valores `None` por `True` o `"Alta"` dependiendo de la variable con la que se iguala.
