...
include-in-header:
  text: |
    <script type="module">
    window.GLOBAL_URL = "https://raw.githubusercontent.com/sebastiandres/pyscape/refs/heads/main/quarto/rooms/sala_15.py";
    </script>
    <style>
...
for exterior in exteriores: #  Se avanza un valor por cada recorrido completo del segundo for
    for interior in interiores: # Se recorre completo
        if exterior + interior == 30
```

Para almacenar los valores pares en una lista se hace de la forma `lista.append((1,2))`
:::
