...
Se debe obtener la suma desde el primer número primo hasta el indicado en el `código secreto`. Tener en consideración que se debe recorrer todos
...
Considerar lo siguiente para el algoritmo de la suma de los primeros `N` números primos:
