...
Debes ordenar la `lista` ocupando la función `.sorted()` y ocupar los `indices` necesarios para crear una nueva
...
- Si el largo de la lista es un número par: Es el promedio de los dos valores que están al medio.
